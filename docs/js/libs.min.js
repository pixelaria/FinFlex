...
$slide.after('<div class="test"><ul class="lSPager '+cl+'"></ul></div>');var gMargin=(settings.vertical)?'margin-left':'margin-top';$slide.parent().find('.lSPager').css(gMargin,settings.galleryMargin+'px');refresh.createPager();}
